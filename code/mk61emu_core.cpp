...
static const uint8_t div3_table[256] = {
...
static const uint16_t mul9_table[256] = {
...
void  cycle(void) {
  ...
  for (int count = 1; count <= MAX_CYCLE; count++){
      ...
      if (IK1302_uI_hi > 0x1f)
      {
        ...
        #if IS_CORTEX_M4()
          m_IK1302.pAND_AMK  = (uint8_t*) &IK1302_AND_AMK[IK1302_uI_hi * 9];
        #else
          m_IK1302.pAND_AMK  = (uint8_t*) &IK1302_AND_AMK[mul9_table[IK1302_uI_hi]];
        #endif
      }
      ...
      if (IK1303_uI_hi > 0x1f)
      {
        ...
        #if IS_CORTEX_M4()
           m_IK1303.pAND_AMK  = (uint8_t*) &IK1303_AND_AMK[IK1303_uI_hi * 9];
        #else
           m_IK1303.pAND_AMK  = (uint8_t*) &IK1303_AND_AMK[mul9_table[IK1303_uI_hi]];
        #endif
      }
      ...
      if (IK1306_uI_hi > 0x1f)
      {
        ...
        #if IS_CORTEX_M4()
          m_IK1306.pAND_AMK  = (uint8_t*) &IK1306_AND_AMK[IK1306_uI_hi * 9];
        #else
          m_IK1306.pAND_AMK  = (uint8_t*) &IK1306_AND_AMK[mul9_table[IK1306_uI_hi]];
        #endif
      }
